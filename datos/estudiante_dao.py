...
class EstudianteDao:
     ...
     _SELECCIONAR_X_CEDULA = "select id, cedula, nombre, apellido, email, carrera, activo, estatura, peso, fecha_nacimiento from Estudiantes " \
                             "where cedula = ?"
     ...
     def insertar_estudiante(cls, estudiante):
         ...
         mensaje = ' '
         try:
              fecha_nacimiento = datetime.datetime.strptime(estudiante.fecha_nacimiento, "%d/%m/%Y")
              with Conexion.obtenerCursor() as cursor:
                  datos = (estudiante.cedula, estudiante.nombre, estudiante.apellido, estudiante.email,
                           estudiante.carrera, estudiante.activo, estudiante.estatura, estudiante.peso, fecha_nacimiento.date())
